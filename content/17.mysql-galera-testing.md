...
- **Garbitrator (garb)**: Lightweight arbitrator for quorum in even-node setups
- **IST/SST**: Incremental/State Snapshot Transfer for node recovery
...
Add a link for credibility: https://galeracluster.com/documentation/html_docs_remove-wsrep-new-cluster/documentation/crash-recovery.html
```bash
