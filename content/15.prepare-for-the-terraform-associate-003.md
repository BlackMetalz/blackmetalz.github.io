...
- After creating resources, terraform will save information of resource (with example of ec2 instance) like instance-id, instance-type, security-group... Let's take a look at example below
```terraform
"resource" : [
    {
        "type" : "aws_instance",
...
- This question could be appearing in exam
