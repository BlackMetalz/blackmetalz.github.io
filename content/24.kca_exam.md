...
Practical Example 1 - Access resource name: If you create namespace `prod` -> `{{request.object.metadata.name}}` = `"prod"`
  ...
  match:
    ...
    - resources:
        kinds:
          - Pod
        namespaces:
          - default  # SAFETGUARD: Only delete pods in 'default' for now
