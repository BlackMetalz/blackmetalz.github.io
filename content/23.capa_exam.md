...
[https://www.udemy.com/course/complete-certified-argo-project-associate-capa-exam-prep/](https://www.udemy.com/course/complete-certified-argo-project-associate-capa-exam-prep/)

# Exam note:

- Exam duration: 90 minutes
- Exam questions: 60 questions
- The exam required 75/100 to pass, I scored 80/100!
- You should memorize and understanding everything in `kind: Application` 
- Another you should care about is [ignoreDifferences](https://argo-cd.readthedocs.io/en/stable/user-guide/diffing/#application-level-configuration)
