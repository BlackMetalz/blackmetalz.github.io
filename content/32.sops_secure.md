...
This creates your private key file (`key.txt`). This file **must be present in the project root** when you build the Docker image. It is ignored by `.dockerignore` so it won't be committed to Git.
