    ...
    Properties:
      ...
      UserData:
        Fn::Base64: |
          ...
          yum install -y httpd
```
- And yeah issue in user data scripts could be fail and will give us hardtime to debug, that is why cloudformation provide a better way, it is cfn-init, let's take a look this picture. Better view/read-able, easy to debug than write bash scrip that contains more than 100 lines xD
...
### EBS Volume
It is like common volume in OpenStack, can be mount to only 1 VM. Locked to AZ for sure, LOL.
