Title: Prepare for Linux Foundation Certified System Administrator (LFCS)
Date: 2025-12-29
Category: Knowledge Base
Tags: linux, certification

![alt text](images/2025/12/44.png)
...
- [Kodekloud Lab](https://learn.kodekloud.com/user/courses/labs-linux-foundation-certified-system-administrator-lfcs/)
...
- 3. Generate Self-signed Cert (single command)
```bash
...
- Or shortcut: `req -x509 -newkey` (generate key + cert at once)
